...
var _15__Changing_Guest_List_1 = require("..//15. Changing Guest List");
console.log("\n printing message indicating number of guests ");
console.log("WE had invited ".concat(_15__Changing_Guest_List_1.guest.length, " guests in Excercise 15"));
